                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 900px;">
                                ...
                                <a href="login.jsp" class="btn btn-primary py-md-3 px-md-5 mt-2">Book Now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="package-item bg-white mb-2">
                            ...
                            <div class="p-4">
                                ...
                                <a class="h5 text-decoration-none" href="banahillblognotlogin.jsp">Ba Na Hill <br> It is a very romantic fantasy paradise.</a>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="package-item bg-white mb-2">
                            ...
                            <div class="p-4">
                                ...
                                <a class="h5 text-decoration-none" href="suoiThanTaiBlogNotLogin.jsp">Suoi Than Tai <br><br> Have Fun With Water.</a>
                                <div class="border-top mt-4 pt-4">
                                    <div class="d-flex justify-content-between">
                                        <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>4.5 <small>(250)</small></h6>
                                        <h5 class="m-0">$350</h5>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="package-item bg-white mb-2">
                            ...
                            <div class="p-4">
                                ...
                                <a class="h5 text-decoration-none" href="myKheBeachBlogNotLogin.jsp">My Khe Paradise <br> One of the most beautiful beaches in Vietnam</a>
                                <div class="border-top mt-4 pt-4">
                                    <div class="d-flex justify-content-between">
                                        <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>4.5 <small>(250)</small></h6>
                                        <h5 class="m-0">$350</h5>
