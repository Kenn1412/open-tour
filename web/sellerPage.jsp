...
<html lang="en">
        ...
        <div class="container-fluid position-relative nav-bar p-0">
            <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
                <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                    <a href="sellerPage.jsp" class="navbar-brand">
    ...
    <center>
        ...
        <h3><a href="check?action=add">Add new service</a></h3>
        <table  border="1" width="80%" >
            ...
            <c:forEach items="${requestScope.data}" var="d" >
                <c:set var="id" value="${d.serviceID}" />
                <tr>
                    <td>${d.serviceID}</td>
                    <td>${d.serviceName}</td>
                    <td>${d.serviceAddress}</td>
                    <td>${d.servicePhone}</td>
                    <td>${d.serviceQuantity}</td>
                    <td>${d.servicePrice}</td>
                    <td> <!-- check : servlet tên là check ? tham chiếu m đưa đi action=update -->
                        <a href="check?action=update&serviceID=${id}">Update</a>
                        <a href="check?action=delete&serviceID=${id}">Delete</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
