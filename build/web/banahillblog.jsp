                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="pb-3">
                            <div class="blog-item">
                                <div class="position-relative">
                                    <img class="img-fluid w-100" src="img/Kinh-nghiem-du-lich-Ba-Na-Hill.jpg" alt="">
                                    <div class="blog-date">
                        ...
                        <form name="f" action="" method="post">
                            ...
                            <table border="1">
                                ...
                                <tbody>
                                    <!-- Kết Nốt Với DB tạo 1 biến ServiceDAO để dễ dàng lấy dữ liệu -->
                                    <jsp:useBean id="db" class="DAO.ServiceDAO"/>
                                    <c:forEach items="${db.getAllServiceByPhone('1900 0000')}" var="p">
                                        <tr>
                                            <td>${p.serviceID}</td>
                                            <td>${p.serviceName}</td>
