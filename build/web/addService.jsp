...
<html lang="en">
        ...
        <div class="container-fluid position-relative nav-bar p-0">
            <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
                <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                    <a href="AdminShowListUserController" class="navbar-brand">
    ...
    <center>
        ...
        <form action="add">
            <!-- comment Enter Service ID: <input type="text" name="serviceID"><br/> -->
            Enter Service Name: <input type="text" name="serviceName"><br/>
            Enter Service Address: <input type="text" name="serviceAddress"><br/>
            Enter Service Phone:<input type="text" name="servicePhone" readonly value="${user.phone}"><br/>
            Enter Service Quantity: <input type="text" name="serviceQuantity"><br/>
            Enter Service Price: <input type="int" name="servicePrice"><br/>
