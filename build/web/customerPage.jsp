                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                    ...
                    <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                        <div class="navbar-nav ml-auto py-0">
                            <a href="customerPage.jsp" class="nav-item nav-link active">Home</a>
                            <a href="#" class="nav-item nav-link">About</a>
                            <a href="#" class="nav-item nav-link">Services</a>
                            <a href="customerCart.jsp" class="nav-item nav-link active">My Cart (${size})</a>
                            <div class="nav-item dropdown">
            ...
            <div id="header-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="w-100" src="img/dannang1.jpg" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 900px;">
                                <h4 class="text-white text-uppercase mb-md-3">Da Nang City</h4>
                                <h1 class="display-3 text-white mb-md-4">Let's Discover The World Together</h1>
                                <a href="daNang.jsp" class="btn btn-primary py-md-3 px-md-5 mt-2">Travel Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img class="w-100" src="img/hue2.jpg" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 900px;">
                    ...
                    <div class="carousel-item">
                        <img class="w-100" src="img/hoian.jpg" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 900px;">
                                <h4 class="text-white text-uppercase mb-md-3">Tours & Travel</h4>
                                <h1 class="display-3 text-white mb-md-4">Let's Discover The World Together</h1>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="destination-item position-relative overflow-hidden mb-2">
                            ...
                            <a class="destination-overlay text-white text-decoration-none" href="daNang.jsp">
                                <h5 class="text-white">Da Nang City</h5>
                                <span>Most Livable City</span>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="destination-item position-relative overflow-hidden mb-2">
                            ...
                            <a class="destination-overlay text-white text-decoration-none" href="">
                                <h5 class="text-white">Hue City</h5>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="destination-item position-relative overflow-hidden mb-2">
                            ...
                            <a class="destination-overlay text-white text-decoration-none" href="">
                                <h5 class="text-white">Hoi An Town</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-5 pb-lg-5">
                        <div class="about-text bg-white p-4 p-lg-5 my-lg-5">
                            ...
                            <p>We are sure to provide great user experience, the website will promote the curiosity of each person, thus motivating us to pack our bags and experience the places pretty</p>
                            <div class="row mb-4">
                                <div class="col-6">
                                    <img class="img-fluid" src="img/dannang1.jpg" alt="">
                                </div>
                                <div class="col-6">
                                    <img class="img-fluid" src="img/hue2.jpg" alt="">
                                </div>
                            </div>
