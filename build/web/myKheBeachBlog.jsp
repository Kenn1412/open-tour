                        ...
                        <div class="pb-3">
                            <div class="blog-item">
                                <div class="position-relative">
                                    <img class="img-fluid w-100" src="img/package-3.jpg" alt="">
                                    <div class="blog-date">
                        ...
                        <form name="f" action="" method="post">
                            ...
                            <table border="1">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${db.getAllServiceByPhone('+84 123 456 789')}" var="p">
                                        <tr>
                                            <td>${p.serviceID}</td>
                                            <td>${p.serviceName}</td>
                                            ...
                                            <td>
                                                ...
                                                <!-- <input type="text" hidden value="banahill.jsp" name="name"> -->
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
